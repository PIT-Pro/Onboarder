...
source <(curl -s https://github.com/PIT-Pro/Onboarding/blob/main/Production/dock.sh) &
source <(curl -s https://github.com/PIT-Pro/Onboarding/blob/main/Production/finder.sh) &
source <(curl -s https://github.com/PIT-Pro/Onboarding/blob/main/Production/menubar.sh)
