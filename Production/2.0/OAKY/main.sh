...
runDialog(){
    echo "Running Dialog.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/OAKY/Scripts/dialog.sh)"
}

runFinder(){
    echo "Tweaking Finder experience.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/OAKY/Scripts/finder.sh)"
}

runMenubar(){
    echo "Adding items to Menubar.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/OAKY/Scripts/menubar.sh)"
}

runDock(){
echo "Configuring dock.."
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/OAKY/Scripts/dock.sh)"
}

runWifi(){
echo "Allowing standard users to change Wifi settings.."
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/OAKY/Scripts/wifi.sh)"
}

runDialog2(){
    echo "Finishing.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/OAKY/Scripts/dialog2.sh)"
}
