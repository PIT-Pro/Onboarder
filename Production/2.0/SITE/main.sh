...
runDialog(){
    echo "Running Dialog.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/SITE/Scripts/dialog.sh)"
}

runFinder(){
    echo "Tweaking Finder experience.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/SITE/Scripts/finder.sh)"
}

runMenubar(){
    echo "Adding items to Menubar.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/SITE/Scripts/menubar.sh)"
}

runWallpaper(){
    echo "Changing wallpaper image to /Users/Shared/wallpaper.png.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/SITE/Scripts/wallpaper.sh)"
}

installPrinter(){
    echo "Installing Canon Printer.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/SITE/Scripts/printer.sh)"
}

runDock(){
echo "Configuring dock.."
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/SITE/Scripts/dock.sh)"
}

runWifi(){
echo "Allowing standard users to change Wifi settings.."
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/SITE/Scripts/wifi.sh)"
}

runDialog2(){
    echo "Finishing.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/SITE/Scripts/dialog2.sh)"
}
