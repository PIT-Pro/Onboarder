...
runDialog(){
    echo "Running Dialog.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/STRG/Scripts/dialog.sh)"
}

runFinder(){
    echo "Tweaking Finder experience.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/STRG/Scripts/finder.sh)"
}

runMenubar(){
    echo "Adding items to Menubar.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/STRG/Scripts/menubar.sh)"
}
...
/bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/STRG/Scripts/wifi.sh)"
}

runDialog2(){
    echo "Finishing.."
    /bin/bash -c "$(curl -fsSL https://raw.githubusercontent.com/PIT-Pro/Onboarder/main/Production/2.0/STRG/Scripts/dialog2.sh)"
}
