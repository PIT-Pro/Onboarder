...
# global check if localadmin is logged in to prevent wrong settings..
if [ -z "localadmin" -o "localadmin" = "loginwindow" ]; then
  echo "localadmin not logged in, cannot proceed"
  exit 1
fi
